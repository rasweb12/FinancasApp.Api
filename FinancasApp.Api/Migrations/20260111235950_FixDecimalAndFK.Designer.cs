...
namespace FinancasApp.Api.Migrations
{
    ...
    [Migration("20260111235950_FixDecimalAndFK")]
    partial class FixDecimalAndFK
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FinancasApp.Api.Models.CreditCard", b =>
                {
                    ...
                    b.HasIndex("CurrentInvoiceId")
                        .IsUnique()
                        .HasFilter("[CurrentInvoiceId] IS NOT NULL");
            ...
            modelBuilder.Entity("FinancasApp.Api.Models.CreditCard", b =>
                {
                    b.HasOne("Invoice", "CurrentInvoice")
                        .WithOne()
                        .HasForeignKey("FinancasApp.Api.Models.CreditCard", "CurrentInvoiceId")
